...
{{-- <div
    style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh; background: linear-gradient(to right, #f8f8f8, #e0e0e0);">
...
{{-- <div
    style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh; background: linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%);">
    <h1 style="font-size: 2.5em; color: #ffffff; text-shadow: 2px 2px 4px #000000;">Welcome to the Dashboard</h1>
    <p style="font-size: 1.2em; color: #ffffff; text-shadow: 1px 1px 2px #000000;">You are logged in. Enjoy your stay!
    </p>
    <button type="button"
